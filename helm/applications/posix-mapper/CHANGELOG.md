...
## [0.7.0](https://github.com/brianmajor/deployments/compare/posixmapper-0.6.0...posixmapper-0.7.0) (2026-04-08)
...
* remove default postgresql database install and require provided… ([a655f7d](https://github.com/brianmajor/deployments/commit/a655f7d60a8b847301f37c852111d0423b962d97))
* update posix mapper image with bug fix ([22bd6ef](https://github.com/brianmajor/deployments/commit/22bd6ef6034e2c551310e114603bdc816617d0d7))
* update posix mapper image with bug fix ([ed52d13](https://github.com/brianmajor/deployments/commit/ed52d137a2091415143c0c0123a2546d70b6f5bd))
...
* move security context for readability and add notes ([bc39ae8](https://github.com/brianmajor/deployments/commit/bc39ae85ebf4e653538ad9b37c3360335cdf4e77))
...
* review rework ([740aeca](https://github.com/brianmajor/deployments/commit/740aeca0d5bc195b89708be97d2bcf9d70d71ecb))
...
* update posix mapper image with bug fix ([22bd6ef](https://github.com/opencadc/deployments/commit/22bd6ef6034e2c551310e114603bdc816617d0d7))
* update posix mapper image with bug fix ([ed52d13](https://github.com/opencadc/deployments/commit/ed52d137a2091415143c0c0123a2546d70b6f5bd))
